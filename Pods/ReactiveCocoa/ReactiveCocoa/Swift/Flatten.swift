...
extension SignalProducerType {
	...
	@warn_unused_result(message="Did you forget to call `start` on the producer?")
    public func prefix<P: SignalProducerType>(previous: P) -> SignalProducer<Value, Error> where P.Value == Value, P.Error == Error {
...
extension SignalType {
	...
	@warn_unused_result(message="Did you forget to call `observe` on the signal?")
    public static func merge<Seq: SequenceType, S: SignalType>(signals: Seq) -> Signal<Value, Error> where S.Value == Value, S.Error == Error, Seq.Generator.Element == S {
	...
	/// from each of them, and complete when all of them have completed.
	@warn_unused_result(message="Did you forget to call `observe` on the signal?")
    public static func merge<S: SignalType>(signals: S...) -> Signal<Value, Error> where S.Value == Value, S.Error == Error {
...
extension SignalProducerType {
	...
	/// from each of them, and complete when all of them have completed.
	@warn_unused_result(message="Did you forget to call `start` on the producer?")
    public static func merge<Seq: SequenceType, S: SignalProducerType>(producers: Seq) -> SignalProducer<Value, Error> where S.Value == Value, S.Error == Error, Seq.Generator.Element == S {
	...
	/// from each of them, and complete when all of them have completed.
	@warn_unused_result(message="Did you forget to call `start` on the producer?")
    public static func merge<S: SignalProducerType>(producers: S...) -> SignalProducer<Value, Error> where S.Value == Value, S.Error == Error {
