...
public final class CompositeDisposable: Disposable {
	...
	/// disposables.
    public init<S: SequenceType>(_ disposables: S) where S.Generator.Element == Disposable {
	...
	/// Initializes a CompositeDisposable containing the given sequence of
	/// disposables.
    public convenience init<S: SequenceType>(_ disposables: S) S.Generator.Element == Disposable? {
